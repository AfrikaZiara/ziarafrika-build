...
/***/ "./src/app/@core/data/admin-tour-packages.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AdminTourPackagesService; });
...
var AdminTourPackagesService = /** @class */ (function () {
    function AdminTourPackagesService(db, router) {
        this.db = db;
        this.router = router;
    }
    AdminTourPackagesService.prototype.addNewTourPackage = function (tour) {
        this.db.list('/tours').push(tour);
        this.router.navigate(['/pages/tables/table-tour-packages']);
    };
    AdminTourPackagesService.prototype.fetchAllTourPackages = function () {
        return this.db.list('/tours').valueChanges();
    };
    AdminTourPackagesService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_angularfire2_database__["a" /* AngularFireDatabase */], __WEBPACK_IMPORTED_MODULE_0__angular_router__["c" /* Router */]])
    ], AdminTourPackagesService);
    return AdminTourPackagesService;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__admin_tour_packages_service__ = __webpack_require__("./src/app/@core/data/admin-tour-packages.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tour_operators_service__ = __webpack_require__("./src/app/@core/data/tour-operators.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
    ...
    DataModule = DataModule_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            ...
            providers: SERVICES.concat([
                __WEBPACK_IMPORTED_MODULE_1__tour_operators_service__["a" /* TourOperatorsService */],
                __WEBPACK_IMPORTED_MODULE_0__admin_tour_packages_service__["a" /* AdminTourPackagesService */]
            ]),
        })
    ], DataModule);
    return DataModule;
...
/***/ "./src/app/@core/data/multiple-chanel.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MultipleChanelService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_angularfire2_database__ = __webpack_require__("./node_modules/angularfire2/database/index.js");
...
var MultipleChanelService = /** @class */ (function () {
    function MultipleChanelService(db) {
        this.db = db;
    }
    MultipleChanelService.prototype.getAllChanels = function () {
        return this.db.list('/channels').valueChanges();
    };
    MultipleChanelService.prototype.getUsers = function () {
        return this.db.list('/users').valueChanges();
    };
    MultipleChanelService = __decorate([
...
var SmartTableService = /** @class */ (function () {
    function SmartTableService(db) {
        this.db = db;
    }
    SmartTableService.prototype.getDataFromDb = function () {
        return this.db.list('/users').valueChanges();
    };
...
/***/ "./src/app/@core/data/tour-operators.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TourOperatorsService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_angularfire2_database__ = __webpack_require__("./node_modules/angularfire2/database/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var TourOperatorsService = /** @class */ (function () {
    function TourOperatorsService(db, router) {
        this.db = db;
        this.router = router;
    }
    TourOperatorsService.prototype.registerTourOperator = function (operator) {
        this.db.list('/tour-operators').push(operator);
        this.router.navigate(['/pages/tables/table-tour-operators']);
    };
    TourOperatorsService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_angularfire2_database__["a" /* AngularFireDatabase */], __WEBPACK_IMPORTED_MODULE_0__angular_router__["c" /* Router */]])
    ], TourOperatorsService);
    return TourOperatorsService;
}());
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.fetchUsersFromFirebase = function () {
        return this.db.list('/users').valueChanges();
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__core_data_tour_operators_service__ = __webpack_require__("./src/app/@core/data/tour-operators.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__core_data_admin_tour_packages_service__ = __webpack_require__("./src/app/@core/data/admin-tour-packages.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__core_data_multiple_chanel_service__ = __webpack_require__("./src/app/@core/data/multiple-chanel.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_4__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_11_angularfire2__["a" /* AngularFireModule */].initializeApp(__WEBPACK_IMPORTED_MODULE_0__environments_environment__["a" /* environment */].firebase),
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__core_data_tour_operators_service__["a" /* TourOperatorsService */],
                __WEBPACK_IMPORTED_MODULE_15__core_data_admin_tour_packages_service__["a" /* AdminTourPackagesService */],
                __WEBPACK_IMPORTED_MODULE_16__core_data_multiple_chanel_service__["a" /* MultipleChanelService */]
            ],
        })
    ], AppModule);
    return AppModule;
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyCmuZwTXAmunGqeweSiEeFuasbHwvnbslM",
        authDomain: "afrika-ziara.firebaseapp.com",
        databaseURL: "https://afrika-ziara.firebaseio.com",
        projectId: "afrika-ziara",
        storageBucket: "afrika-ziara.appspot.com",
        messagingSenderId: "259941993438"
    }
};
